...
namespace Auren.Application.Extensions
{
    ...
    {
        public static (DateTime start, DateTime end) GetTimePeriodRange(this TimePeriod? timePeriod)
        {
        ...
        public static (DateTime start, DateTime end) GetPreviousTimePeriodRange(this TimePeriod? timePeriod)
        {
            return timePeriod switch
            {
